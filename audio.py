...
async def botinfo(ctx):
	...
	embed.add_field(name="Invite link", value="[Click Here!](https://discordapp.com/api/oauth2/authorize?client_id=498036721104060417&permissions=8&scope=bot)")
...
async def help(ctx):
    ...
    embed.add_field(name="__Moderations Commands:__", value="```\nkick :: [b.kick @user reason]\nban :: [b.ban @user reason]\nmute :: [b.mute @user reason]\nunmute :: [b.unmute @user reason]\nwarn :: [b.warn @user reason]\nclear :: [ex= b.clear 10]\nsay :: [b.say <your msg>]\ndm :: [b.dm @user msg]\nunban :: [b.unban userID]\nsetupwelcomer :: [b.setupwelcomer]\nsetuplog :: [b.setuplog]\nannounce :: [b.announce #channel <your msg>]\nembed :: [b.embed <your msg>]```",inline = False)
